...
- [x] 4.1 Update `README.md` Vitest Browser Mode section and `examples/vitest-browser/README.md`: passing visual tests appear with baseline preview and stay approvable; first-run UX unchanged. Verify: manual review against spec scenarios
